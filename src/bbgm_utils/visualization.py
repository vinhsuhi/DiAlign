...
from src.bbgm_utils import latex_utils as lu
from src.bbgm_utils.decorators import input_to_numpy
from src.bbgm_utils.utils import UnNormalize, n_and_l_iter_parallel, lexico_iter
...
def easy_visualize(
    ...
    unnorm = UnNormalize(NORM_MEANS, NORM_STD)
